...
<div id="work">
	<div class="container_16">
		...
		<div class="gallery">
			<div class="grid_5">
				<a href="jump?url=WEB-INF/upload.jsp" ><div class="screenshot1 ss"></div></a>
				<p>PPT浏览<br />
				<span class="ss_text">
					<a href="jump?url=WEB-INF/upload.jsp">上传</a>
					<a href="/servlet/ListFileServlet">下载</a>
				</span>
				</p>
			</div>
			<div class="grid_6">
				<a href="jump?url=WEB-INF/listStyle.jsp"><div class="screenshot2 ss center"></div></a>
				<p>重难点讲解<br />
			...
			<div class="grid_5">
				<a href="msgpane/submit.jsp"><div class="screenshot6 ss"></div></a>
				<p>共性问题<br />
...
<div id="about">
	<div class="container_16">
		...
		<div class="subheader">
			<div class="subheader_line"></div><h2>发布作业</h2><div class="subheader_line"></div>
		</div>
	
	<div class="grid_5">
		<form action="${pageContext.request.contextPath}/StringUploadServlet" enctype="multipart/form-data" method="post" >

				<textarea id="text" cols="65" rows="8" name="message"></textarea>

            <div class="skills">
            <table style="clear:right;width:350px;height:150px;text-align:center;margin-top:5px;">
                <tr>
                    <td >章序 </td>
                    <td><input type="text" name="chapter" style="width:180px;" /></td>
                </tr>

                <tr>
                    <td >节序 </td>
                    <td><input type="text" name="index" style="width:180px;" /></td>
                </tr>

                <tr><td >难度 </td><td >
                    <input type = "radio" name = "strType" value = "1">基本知识 &nbsp
                    <input type = "radio" name = "strType" value = "2">基础技能 &nbsp
                    <input type = "radio" name = "strType" value = "3">重点内容 &nbsp
                    <input type = "radio" name = "strType" value = "4">难点内容 &nbsp
                </td><td>  </td></tr>
