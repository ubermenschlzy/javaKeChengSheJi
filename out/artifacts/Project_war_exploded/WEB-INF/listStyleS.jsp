        ...
        <div id="content_bg">
            <div id="contents">
                ...
                <div id="con_c">
                    <ul class="list_c">
                        <!--分页条数：15-->
                        <c:url value="/ListFileServletS"  var="a1">
                            <c:param name="type" value="1"></c:param>
                        </c:url>
                        <c:url value="/ListFileServletS"  var="a2">
                            <c:param name="type" value="2"></c:param>
                        </c:url>
                        <c:url value="/ListFileServletS"  var="a3">
                            <c:param name="type" value="3"></c:param>
                        </c:url>
                        <c:url value="/ListFileServletS"  var="a4">
                            <c:param name="type" value="4"></c:param>
                        </c:url>
                        <c:url value="/ListFileServletS"  var="a5">
                            <c:param name="type" value="5"></c:param>
                        </c:url>
                        <c:url value="/ListFileServletS"  var="a6">
                            <c:param name="type" value="6"></c:param>
                        </c:url>
                        <c:url value="/ListFileServletS"  var="a7">
